...
namespace TranslationProvider.Core.ApplicationService.Cultures.Commands.Disable;

public sealed class CultureDisableHandler(ZaminServices zaminServices, ICultureCommandRepository commandRepository)
